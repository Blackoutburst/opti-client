...
readonly F_DISABLED="-Wno-gnu-zero-variadic-macro-arguments"
readonly FRAMEWORKS="-framework Cocoa -framework IOKit"

### GCC ###

printf "\e[94mGCC\e[0m: "
gcc -o $NAME $SRC $INCLUDE $GLFW $VK $F_ERROR $F_DEBUG $F_DISABLED $FRAMEWORKS
GCC_EXIT=$?
...
clang -o $NAME $SRC $INCLUDE $GLFW $VK $F_ERROR $F_DEBUG $F_DISABLED $FRAMEWORKS
CLANG_EXIT=$?
